...
<nav class="navbar navbar-expand-lg navbar-light sticky" style="background-color:#2288cc">
        <div class="container-fluid">
            ...
            <?php if(isset($_SESSION['category'])){
                echo "<a class='navbar-brand brand' href='product.php'><i class='fas fa-arrow-left'></i></a>";
            }
            else{
                echo "<a class='navbar-brand brand' href='index.php'><i class='fas fa-arrow-left'></i></a>";
            } 
            ?>
            <a class="navbar-brand" aria-current="page" href="index.php" style='color:white'><h4>Home</h4></a>
    ...
    <div class="form">
        <form action="server.php" method="post">         
            <div>       
                ...
                <input type="text" id="username" name="username" placeholder="Enter user name" class="input" required><br><br>                   
            
                <input type="password" id="pwd" name="pwd" placeholder="Enter password" class="input" required><br><br>
...
<div class="sign" id="signin">
    <div class="form">
        <form action="server.php" method="post">          
            <div>
                <br><br>
                <h2 style="text-align:center;font-family: 'Times New Roman', Times, serif;font-weight: bold;">Create Your Account</h2><br><br>
                <input type="text"  name="username" placeholder="Enter user name" class="input" required><br><br>                   
                <input type="text"  name="number" placeholder="Enter mobile number" class="input" required><br><br>
                <input type="password"  name="pwd1" placeholder="Enter password" class="input" required><br><br>
               
                <input type="password"  name="pwd2" placeholder="Confirm password" class="input" required><br><br>
                <button type="submit" name="reg_user" class="but">Create</button><br><br>
                <p style="text-align:center;font-size:20px;">already have an account? click <a class="a" onclick="document.getElementById('signin').style.display='none';document.getElementById('login').style.display='block'">here</a> to Log in.</p><br><br>
            </div>               
        </form> 
    </div>
</div>
