        ...
        border-radius: 5px;'>
            ...
            <div class='card-body'>
                ...
                <div class='card-text'>
                        ...
                        <button type='submit' class='btn btn-primary d-grid mx-auto view'>View variety</button>   
                </div>                   
            </div>
        </div>
    </div>
...
function item_component($productname,$productimg,$price,$productid){
    ...
    <form method='post'>
        ...
        <div class='info'>
            <div class='title'>
                <h2>$productname</h2>
                <p>A delightfully delicious all time loved $productname.</p>
            </div>
            <div class='price'>
        ...
        <div class='btn'>
            <button name='add' style='background-color:#2288cc'>ADD TO CART</button>
        </div>
        </form>
    </div>
        ...
        <div class='border rounded'>
            <div class='row bg-white'>
                ...
                <div class='col-md-6'>
                    ...
                    <small class='text-secondary'>Seller: ecart</small>
